  ...
  return (
    <div className={utilStyles.Contact}>
      ...
      <div style={{display: "flex", flexDirection: "column"}}>
        ...
        <a style={{display: "inline-block", WebkitTextFillColor: "transparent",background: "linear-gradient(90deg, rgba(8,133,27,1) 0%, rgba(233,233,233,1) 76%, rgba(255,255,255,1) 100%)", WebkitBackgroundClip: "text", textDecoration: "none", display: "flex", flexDirection: "row"}} href="mailto:mr.silver.mg@gmail.com"><img src="/images/gmail.png" />Send me Mail</a>
        ...
        <a style={{display: "inline-block", WebkitTextFillColor: "transparent",background: "linear-gradient(90deg, rgba(29,161,242,1) 0%, rgba(163,221,255,1) 50%, rgba(255,255,255,1) 100%)", WebkitBackgroundClip: "text", textDecoration: "none", display: "flex", flexDirection: "row"}} href="https://twitter.com/1silvermami1"><img src="/images/twitter.png" />Follow me on Twitter</a>
        </div>
      </div>
      <Image 
